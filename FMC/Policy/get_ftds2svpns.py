...
Connects to a Cisco FMC and retrieves list of all FTD Site to Site
VPN topologies, saving the result to a JSON file.
...
OUTPUT_FILE: str = "../Responses/ftds2svpns.json"
...
def main() -> None:
    ...
    if not response:
        logger.warning("No FTD Site to Site VPN topologies found in FMC.")
        raise SystemExit(0)
